...
# ====================================================================
printf "\nThis is the setup for the App Int API Key Expiry report sample.\n\n"
...
# Replace all the keywords and content files
INTEGRATION_FILE="${EXAMPLE_NAME}-${rand_string}.json"
cp ./content/apikey-expiry-checker-multiorg-v26-template.json "$INTEGRATION_FILE"
